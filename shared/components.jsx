...
const ALL_PAGES = [
  ...
  {key:'creative',      nl:'Creatieve agencies',    en:'Creative agencies',    file:'Creatieve Agencies.html'},
  {key:'professional',  nl:'Prof. services',         en:'Prof. services',        file:'Professional Services.html'},
  {key:'cowork',        nl:'Cowork & flex',          en:'Cowork & flex',         file:'Cowork - Flex.html'},
  {key:'finance',       nl:'Finance',                en:'Finance',               file:'Verzekeringen - Finance.html'},
  {key:'horeca',        nl:'HoReCa',                 en:'HoReCa',                file:'Boutique HoReCa.html'},
  {key:'ngo',           nl:"NGO's",                  en:"NGOs",                  file:"NGOs - Fondsen.html"},
];
...
function Nav({active}) {
  ...
  return (
    <nav style={{
      ...
      <a href="B-Corp - ESG.html" style={{cursor:'pointer',display:'flex',alignItems:'center'}}>
